  ...
  <div class="master-panel">
    ...
    <div class="panel-content">
      <a-row class="panel-name"
        >To Perform Control Data Set Operations, Specify:</a-row
      >
      ...
      <a-row>
        ...
        <a-col :span="17" class="panel-desc"
          >- Display the Base Configuration</a-col
        >
      </a-row>
      <a-row>
        ...
        <a-col :span="17" class="panel-desc"
          >- Define the Base Configuration</a-col
        >
      </a-row>
      <a-row>
        ...
        <a-col :span="17" class="panel-desc"
          >- Alter the Base Configuration</a-col
        >
      </a-row>
      <a-row>
      ...
      <a-row>
        ...
        <a-col :span="17" class="panel-desc"
          >- Display CF Cache Structure Names for all CF Cache Sets</a-col
        >
      </a-row>
      <a-row>
        ...
        <a-col :span="17" class="panel-desc"
          >- Define/Alter/Delete CF Cache Sets</a-col
        >
      </a-row>
      <a-row>
        ...
        <a-col :span="17" class="panel-desc"
          >- Display CF Lock Structure Names for all CF Lock Sets</a-col
        >
      </a-row>
      <a-row>
        ...
        <a-col :span="17" class="panel-desc"
          >- Define/Alter/Delete CF Lock Sets</a-col
        >
      </a-row>
    </div>
  </div>
